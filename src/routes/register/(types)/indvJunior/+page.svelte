	...
	<form action="?/confirmDetails" method="POST" on:change={saveProgress} class="space-y-4 text-xl p-4">
		<div>
			...
			<p class="text-sm text-muted-foreground">
				ตัวอย่าง 40000 นายเอสที สตาร์ ม.6/9 เลขที่ 24
			</p>
		</div>
		...
		<div class="flex flex-col gap-4">
			...
			{#each [
				...
				{ name: 'กีต้าร์โปร่งไฟฟ้า', value: instrumentsArray[2] },
				{ name: 'กีต้าร์โปร่งไฟฟ้า 2', value: instrumentsArray[3] },
				{ name: 'กีต้าร์ไฟฟ้า', value: instrumentsArray[4] },
